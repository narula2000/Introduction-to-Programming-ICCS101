...
assert(bell.loveTri(5) == [[1], [1, 2], [2, 3, 5],
                           [5, 7, 10, 15], [15, 20, 27, 37, 52]])
...
assert(sgroup.separate([1, 1.2, 4.5, 4.7, 9.1, 9.8, 9.9], 7) == [
       [1], [1.2], [4.5], [4.7], [9.1], [9.8], [9.9]])
assert(sgroup.separate([1, 1.2, 4.5, 4.7, 9.1, 9.8, 9.9], 6) == [
       [1], [1.2], [4.5], [4.7], [9.1], [9.8, 9.9]])
assert(sgroup.separate([1, 1.2, 4.5, 4.7, 9.1, 9.8, 9.9], 5) == [
       [1, 1.2], [4.5], [4.7], [9.1], [9.8, 9.9]])
